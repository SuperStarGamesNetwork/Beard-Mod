	...
	public void registerIcons(IIconRegister par1iconRegister) {
		if (itemID == IronManMod.HulkbusterHead.itemID) {
			itemIcon = par1iconRegister
					.registerIcon("IronManMod:HulkBuster Head");
		}
		if (itemID == IronManMod.HulkbusterBoots.itemID) {
			itemIcon = par1iconRegister
					.registerIcon("IronManMod:HulkBuster Boots");
		}
		if (itemID == IronManMod.HulkbusterLeggs.itemID) {
			itemIcon = par1iconRegister
					.registerIcon("IronManMod:HulkBuster Leggs");
		}
		if (itemID == IronManMod.HulkbusterBody.itemID) {
			itemIcon = par1iconRegister
					.registerIcon("IronManMod:HulkBuster Body");
		}
	}
